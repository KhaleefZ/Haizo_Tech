              ...
              {list.map((w, i) => (
                <Reveal key={w.id} delay={(i % 3) * 60}>
                  <Link
                    ...
                    className="group block h-full overflow-hidden rounded-token border border-border bg-card shadow-card transition-[transform,box-shadow,border-color] hover:-translate-y-1 hover:border-brand-blue hover:shadow-lift"
                  >
